...
STATE_TEXT[STATE_ACTIVATING] = 'STATE_ACTIVATING'; // [/DEBUG]
...
function switchDraggable(props) {
  // [DEBUG]
  traceLog.push('<switchDraggable>', "_id:".concat(props._id), "state:".concat(STATE_TEXT[props.state])); // [/DEBUG]

  if (props.plainDraggable) {
    // [DEBUG]
    traceLog.push("plainDraggable.disabled:".concat(!(props.options.dragHandle && props.state === STATE_OPENED))); // [/DEBUG]
    ...
    traceLog.push('plainDraggable:NONE'); // [/DEBUG]
  }
...
function finishOpening(props) {
  // [DEBUG]
  traceLog.push('<finishOpening>', "_id:".concat(props._id), "state:".concat(STATE_TEXT[props.state])); // [/DEBUG]
  ...
  if (props.parentProps) {
    // [DEBUG]
    traceLog.push("parentProps._id:".concat(props.parentProps._id), "parentProps.state:".concat(STATE_TEXT[props.parentProps.state])); // [/DEBUG]

    props.parentProps.state = STATE_INACTIVATED;
    traceLog.push("parentProps.state:".concat(STATE_TEXT[props.parentProps.state])); // [DEBUG/]
  }
...
function finishClosing(props) {
  // [DEBUG]
  traceLog.push('<finishClosing>', "_id:".concat(props._id), "state:".concat(STATE_TEXT[props.state]));
  ...
  shownProps.pop(); // [DEBUG]

  traceLog.push("shownProps:".concat(shownProps.length ? shownProps.map(function (props) {
    return props._id;
  }).join(',') : 'NONE')); // [/DEBUG]
  ...
  if (props.parentProps) {
    ...
    traceLog.push("parentProps(UNLINK):".concat(props.parentProps._id)); // [DEBUG/]
...
function finishOpenEffect(props, effectKey) {
  // [DEBUG]
  traceLog.push('<finishOpenEffect>', "_id:".concat(props._id), "state:".concat(STATE_TEXT[props.state]));
  traceLog.push("effectKey:".concat(effectKey)); // [/DEBUG]
  ...
  props.effectFinished[effectKey] = true; // [DEBUG]

  traceLog.push("effectFinished.plainOverlay:".concat(props.effectFinished.plainOverlay));
  traceLog.push("effectFinished.option:".concat(props.effectFinished.option));
  traceLog.push("openEffect:".concat(props.options.openEffect ? 'YES' : 'NO')); // [/DEBUG]

  if (props.effectFinished.plainOverlay && (!props.options.openEffect || props.effectFinished.option)) {
    finishOpening(props);
  }

  traceLog.push("_id:".concat(props._id), '</finishOpenEffect>'); // [DEBUG/]
}
/**
 * @param {props} props - `props` of instance.
 * @param {string} effectKey - `plainOverlay' or 'option`
...
function finishCloseEffect(props, effectKey) {
  // [DEBUG]
  traceLog.push('<finishCloseEffect>', "_id:".concat(props._id), "state:".concat(STATE_TEXT[props.state]));
  traceLog.push("effectKey:".concat(effectKey)); // [/DEBUG]
  ...
  traceLog.push("effectFinished.plainOverlay:".concat(props.effectFinished.plainOverlay));
  traceLog.push("effectFinished.option:".concat(props.effectFinished.option));
  traceLog.push("closeEffect:".concat(props.options.closeEffect ? 'YES' : 'NO')); // [/DEBUG]

  if (props.effectFinished.plainOverlay && (!props.options.closeEffect || props.effectFinished.option)) {
    finishClosing(props);
  }

  traceLog.push("_id:".concat(props._id), '</finishCloseEffect>'); // [DEBUG/]
}
/**
...
function execOpening(props, force) {
  // [DEBUG]
  traceLog.push('<execOpening>', "_id:".concat(props._id), "state:".concat(STATE_TEXT[props.state]));
  traceLog.push("force:".concat(!!force)); // [/DEBUG]
  ...
  if (props.parentProps) {
    ...
    */
    ...
    if (parentProps.state === STATE_OPENED) {
      elmOverlay.style[cssprefix__WEBPACK_IMPORTED_MODULE_0__["default"].getName('transitionDuration')] = props.options.duration === DURATION ? '' : "".concat(props.options.duration, "ms"); // [DEBUG]

      traceLog.push('elmOverlay.duration:' + (props.options.duration === DURATION ? '' : "".concat(props.options.duration, "ms"))); // [/DEBUG]
    }
    ...
    elmOverlayClassList.add(STYLE_CLASS_OVERLAY_HIDE); // [DEBUG]

    traceLog.push("elmOverlay.CLASS_FORCE:".concat(elmOverlayClassList.contains(STYLE_CLASS_OVERLAY_FORCE)));
    traceLog.push("elmOverlay.CLASS_HIDE:".concat(elmOverlayClassList.contains(STYLE_CLASS_OVERLAY_HIDE))); // [/DEBUG]
  ...
  traceLog.push("_id:".concat(props._id), '</execOpening>'); // [DEBUG/]
}
/**
 * Process after preparing data and adjusting style.
 * @param {props} props - `props` of instance.
...
function execClosing(props, force, sync) {
  // [DEBUG]
  traceLog.push('<execClosing>', "_id:".concat(props._id), "state:".concat(STATE_TEXT[props.state]));
  traceLog.push("force:".concat(!!force), "sync:".concat(!!sync)); // [/DEBUG]
  ...
  if (props.parentProps) {
    ...
    */
    ...
    var elmOverlayClassList = Object(m_class_list__WEBPACK_IMPORTED_MODULE_1__["default"])(elmOverlay);
    elmOverlayClassList.toggle(STYLE_CLASS_OVERLAY_FORCE, !!force);
    elmOverlayClassList.remove(STYLE_CLASS_OVERLAY_HIDE); // [DEBUG]
  ...
  traceLog.push("_id:".concat(props._id), '</execClosing>'); // [DEBUG/]
}
/**
...
function fixOpenClose(props) {
  // [DEBUG]
  traceLog.push('<fixOpenClose>', "_id:".concat(props._id), "state:".concat(STATE_TEXT[props.state])); // [/DEBUG]
  ...
  traceLog.push("_id:".concat(props._id), '</fixOpenClose>'); // [DEBUG/]
}
/**
 * @param {props} props - `props` of instance.
 * @param {boolean} [force] - Skip effect.
...
function _open(props, force) {
  traceLog.push('<open>', "_id:".concat(props._id), "state:".concat(STATE_TEXT[props.state])); // [DEBUG/]
  ...
  */
  ...
  traceLog.push("openCloseEffectProps:".concat(openCloseEffectProps ? openCloseEffectProps._id : 'NONE')); // [/DEBUG]
  ...
  if (props.state === STATE_CLOSED) {
    ...
    if (shownProps.length) {
      ...
      traceLog.push("parentProps(LINK):".concat(props.parentProps._id)); // [DEBUG/]
    }

    shownProps.push(props); // [DEBUG]

    traceLog.push("shownProps:".concat(shownProps.length ? shownProps.map(function (props) {
      return props._id;
    }).join(',') : 'NONE')); // [/DEBUG]

    Object(m_class_list__WEBPACK_IMPORTED_MODULE_1__["default"])(props.elmOverlay).add(STYLE_CLASS_OVERLAY_FORCE).remove(STYLE_CLASS_OVERLAY_HIDE); // [DEBUG]

    traceLog.push("elmOverlay.CLASS_FORCE:".concat(Object(m_class_list__WEBPACK_IMPORTED_MODULE_1__["default"])(props.elmOverlay).contains(STYLE_CLASS_OVERLAY_FORCE)));
    traceLog.push("elmOverlay.CLASS_HIDE:".concat(Object(m_class_list__WEBPACK_IMPORTED_MODULE_1__["default"])(props.elmOverlay).contains(STYLE_CLASS_OVERLAY_HIDE))); // [/DEBUG]
  }

  execOpening(props, force);
  traceLog.push("_id:".concat(props._id), '</open>'); // [DEBUG/]
...
function _close(props, force) {
  traceLog.push('<close>', "_id:".concat(props._id), "state:".concat(STATE_TEXT[props.state])); // [DEBUG/]
  ...
  */
  ...
  if (props.state === STATE_INACTIVATED) {
    ...
    while ((topProps = shownProps[shownProps.length - 1]) !== props) {
      ...
      traceLog.push("topProps._id:".concat(topProps._id), "topProps.state:".concat(STATE_TEXT[topProps.state])); // [/DEBUG]
  ...
  */
  ...
  traceLog.push("_id:".concat(props._id), '</close>'); // [DEBUG/]
  ...
  function PlainModal(content, options) {
    ...
    if (!document.getElementById(STYLE_ELEMENT_ID)) {
      ...
      window.addEventListener('keydown', function (event) {
        ...
        if (closeByEscKey && ((key = event.key.toLowerCase()) === 'escape' || key === 'esc') && (topProps = shownProps.length && shownProps[shownProps.length - 1]) && (traceLog.push('<keydown/>', 'CLOSE', "_id:".concat(topProps._id)), true) && // [DEBUG/]
        _close(topProps)) {
          event.preventDefault();
    ...
    Object(m_class_list__WEBPACK_IMPORTED_MODULE_1__["default"])(content).add(STYLE_CLASS_CONTENT); // Overlay
    ...
    elmOverlay.addEventListener('click', function (event) {
      if (event.target === elmOverlay && closeByOverlay) {
        traceLog.push('<overlayClick/>', 'CLOSE', "_id:".concat(props._id)); // [DEBUG/]
    ...
    props.effectDone = function () {
      traceLog.push('<effectDone/>', "_id:".concat(props._id), "state:".concat(STATE_TEXT[props.state])); // [DEBUG/]
...
window.PlainOverlay = plain_overlay__WEBPACK_IMPORTED_MODULE_2__["default"]; // [/DEBUG]
